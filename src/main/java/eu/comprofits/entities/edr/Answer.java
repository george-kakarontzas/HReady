...
@NamedQueries({
    ...
    @NamedQuery(name = "Answer.findByIdAnswer", query = "SELECT q FROM Answer q WHERE q.idanswer = :idanswer"),
    @NamedQuery(name = "Answer.findByAnswer", query = "SELECT q FROM Answer q WHERE q.answer = :answer")
    })
