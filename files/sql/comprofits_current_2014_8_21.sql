...
COPY assessment (idassessment, date_created, assessee_idemployee, immediate_manager_idemployee, colleague1_idemployee, colleague2_idemployee, colleague3_idemployee) FROM stdin;
\.
...
COPY employee (idemployee, identity_card_number, social_security_number, first_name, last_name, gender, province, address, postal_code, city, country, date_of_birth, phone_private, phone_mobile, email, photo_path, username, password, marital_status, number_of_children, department_iddepartment, current_in_company_employment_id, role) FROM stdin;
18	11111111	2222222	Julian	Julius	1	Attica	Patision 15	444444	Athens	Greece	1984-08-15	+307777777	+306874555555	julian@julius.com	ee92e05c-b4c5-11e3-9123-22000ab82dd9-large_9198915337726349861.jpeg	julian	ce0fee7e61f9c74f1110f0e5940a80b4f059f189217d0c3d26bb41960d4bf597	M	1	4	\N	employee
7	C4333444	098223332	Simin	Julian	1	London	Jame Str.	43343	London	UK	1975-10-23	+4402020342	+4467887889	simon@bean.uk	\N	simon	0a5d17d3b19f82f8340d3977609aa9e86b4ad8b9bd71bd9eced9271f1d5b2e4a	m	1	4	\N	depthead
3	AK966290	072303177	George	Kakarontzas	1	Thessalia	Em. Manousaki 3A	41447	Larissa	Greece	1966-10-05	+302410251752	+306974722417	gkakaron@teilar.gr	GeorgeKakarontzas_8303174826490623038.png	george	0522a55e2d5f0993a3d66d28864b2862a7218a75ea7968b075333434404485c3	M	1	2	9	depthead
5	F234567	092334245	David	Lemons	1	Thessalia	TEI of Larissa	41110	Larissa	Greece	1962-04-20	+302410684459	+306973765789	david@teilar.gr	robert_8064800178828342190.jpg	david	07d046d5fac12b3f82daf5035b9aae86db5adc8275ebfbf05ec83005a4a8ba3e	M	2	2	\N	administrator
4	M863817	019233876	Natalia	Norena	2	Thessalia	Em. Manousaki 3A	41447	Larissa	Greece	1967-03-20	+302410251752	+306974573364	sales@nataliasilver.com	Buena11_1587965211000926522.jpg	natalia	5183d093e6153294550841731a95acacadca6fe133bb36e0f7a3bbe6342e8dc7	M	1	2	27	hrrecruiter
\.
...
SELECT pg_catalog.setval('employee_idemployee_seq', 18, true);
...
SELECT pg_catalog.setval('essional_experience_record_idprofessional_experience_record_seq', 3, true);
...
SELECT pg_catalog.setval('idassessment_seq', 1, false);
...
SELECT pg_catalog.setval('idcompetence_seq', 30, true);
...
SELECT pg_catalog.setval('iddepartment_seq', 5, true);
...
SELECT pg_catalog.setval('idedr_seq', 1, false);
...
SELECT pg_catalog.setval('idemployee_competence_assessment_seq', 1, false);
...
SELECT pg_catalog.setval('idin_company_employment_seq', 33, true);
...
SELECT pg_catalog.setval('idjob_advertisement_seq', 1, false);
...
SELECT pg_catalog.setval('idjob_application_seq', 1, false);
...
SELECT pg_catalog.setval('idstudy_record_seq', 3, true);
...
COPY job (idjob, job_title, job_description, organisational_position_idorganisational_position, reporting_to_idemployee, business_area_idbusiness_area, place_employment_idplace_employment) FROM stdin;
2	Head of Department	sdsdfsf	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('job_applicant_idjob_applicant_seq', 1, false);
...
SELECT pg_catalog.setval('job_idjob_seq', 2, true);
...
--
-- Data for Name: question-answer; Type: TABLE DATA; Schema: public; Owner: comprofits
--

COPY "question-answer" (idquestion, question_category, question, answer, edr_idedr) FROM stdin;
\.
...
SELECT pg_catalog.setval('statement_idstatement_seq', 1, false);
...
1	Degree in Informatics	1	Athens University of Business and Economics	1985-09-02	1990-06-30	3
\.
